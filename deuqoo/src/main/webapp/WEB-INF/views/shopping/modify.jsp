	...
	<div class="input-wrap">
		<form action="update.tv" method="post" class="form-style-i" enctype="multipart/form-data">
			<ul>
				...
				<li>
					<input type="text" name="shopping_header" class="need" title="말머리" value="${vo.shopping_header }">
				</li>
			</ul>
			<ul>
				<li>
					<select name="shopping_division" id="selecDiv" title="분류">
							<option disabled selected>분류</option>
							<option value="한드" ${vo.shopping_division eq '한드' ? 'selected' : '' }>한드</option>
							<option value="미드" ${vo.shopping_division eq '미드' ? 'selected' : '' }>미드</option>
							<option value="영드" ${vo.shopping_division eq '영드' ? 'selected' : '' }>영드</option>
							<option value="일드" ${vo.shopping_division eq '일드' ? 'selected' : '' }>일드</option>
							<option value="중드" ${vo.shopping_division eq '중드' ? 'selected' : '' }>중드</option>
							<option value="기타" ${vo.shopping_division eq '기타' ? 'selected' : '' }>기타</option>
					</select>
				</li>			
				<li>
					<input type="text" name="shopping_title" class="need" title="제목" value="${vo.shopping_title }">
				</li>
			</ul>
			<ul>
				<li>
