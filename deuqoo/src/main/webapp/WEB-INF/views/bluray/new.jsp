...
<body>
	<div class="input-wrap">
		<form action="insert.bl" method="post" class="form-style-i" enctype="multipart/form-data">
			<ul>
				<li>
					<select>
				...
				<li>
					<input type="text" name="bluray_header" class="need" title="말머리"
			...
			<ul>
				<li>
					<select name="bluray_division" class="selecDiv" title="분류">
				...
				<li>
					<input type="text" name="bluray_title" class="need" title="제목"
			...
			<ul>
				<li>
					<textarea name="bluray_content" id="smartEditor" title="내용"></textarea>
				</li>
			</ul>
		</form>
		<div class="btnSet">
			<a class="btn-fill" id="saveBtn" onclick="go_submit();">등록</a>
			<a class="btn-empty" href="list.bl">취소</a>
		</div>
	</div>
