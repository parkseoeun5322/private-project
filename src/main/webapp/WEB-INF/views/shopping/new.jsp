...
<body>
	<div class="input-wrap">
		<form action="insert.tv" method="post" class="form-style-i" enctype="multipart/form-data">
			<ul>
				<li>
					<select>
				...
				<li>
					<input type="text" name="shopping_header" class="need" title="말머리"
			...
			<ul>
				<li>
					<select name="shopping_division" class="selecDiv" title="분류">
				...
				<li>
					<input type="text" name="shopping_title" class="need" title="제목"
			...
			<ul>
				<li>
					<textarea name="shopping_content" id="smartEditor" title="내용"></textarea>
				</li>
			</ul>
		</form>
		<div class="btnSet">
			<a class="btn-fill" id="saveBtn" onclick="go_submit();">등록</a>
			<a class="btn-empty" href="list.tv">취소</a>
		</div>
	</div>
